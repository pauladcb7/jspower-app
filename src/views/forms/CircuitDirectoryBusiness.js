                            ...
                            {({ input, meta }) => (
                              <>
                                <CFormGroup>
                                  ...
                                  <CInput {...input} type="date" id="date" invalid={meta.invalid && meta.touched} />
                                  {meta.touched && meta.error && <CInvalidFeedback className="help-block">
                            ...
                            {({ input, meta }) => (
                              ...
                              <>
                                <CFormGroup>
                                  ...
                                  <CInput {...input} invalid={meta.invalid && meta.touched} id="voltage" />
                                  {meta.touched && meta.error && <CInvalidFeedback className="help-block">
                                      Please provide a valid information
                                    </CInvalidFeedback>
                                  }
                                  ...
                                  return (
                                    <td className="py-2"  style={{minWidth: 120}}>
                                      <CInput
                                        ...
                                        onChange={(e) => {
                                          const rowsT = [...rows];
                                          rowsT[index]['load1'] = e.target.value
                                          setRow(rowsT)
                                        }}
                                      />
                                    </td>
